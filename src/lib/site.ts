...
export const offerCategories: OfferCategory[] = [
  ...
  },
  {
    ...
    image: "/offers/weekend-dental.jpg",
    items: [
      {
  ...
  },
  {
    ...
    image: "/offers/skin-cleaning.jpg",
    items: [
      {
